...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(&w, SIGNAL(showQue(QString,QString,int,int)),
            &questionpage, SLOT(receiveShow(QString,QString,int,int)));

    QObject::connect(&questionpage, SIGNAL(return_main(QString,QString,int,int)),
            &w, SLOT(que_return_main(QString,QString,int,int)));
    ...
    QObject::connect(&w,SIGNAL(showSelect(QString,QString,int,int,int)),
                     &selectpage,SLOT(receive_Show(QString,QString,int,int,int)));
    ...
    QObject::connect(&selectpage,SIGNAL(sel_to_game(QString,QString,int,int,int,int)),
                     &playpage,SLOT(receive_Sel(QString,QString,int,int,int,int)));
    ...
    QObject::connect(&playpage,SIGNAL(go_to_next(QString,QString,int,int,int,int)),
                     &playpage,SLOT(receive_from_last(QString,QString,int,int,int,int)));
